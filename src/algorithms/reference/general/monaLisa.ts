	...
	control: {
		nodes: [
			...
			},
			{
				...
				params: {
					label: { v: "Eye Color" },
					value: { v: { r: 0.18, g: 0.14, b: 0.1, a: 0.85 } },
				},
			},
			{
				id: "smileColor",
				...
				params: {
					label: { v: "Smile Color" },
					value: { v: { r: 0.55, g: 0.28, b: 0.2, a: 0.55 } },
				},
			},
			{
				id: "linkRate",
		...
		nodes: [
			...
			},
			{
				...
				params: {
					...
					radius: { v: 0.009 },
					color: { v: { r: 0.18, g: 0.14, b: 0.1, a: 1.0 } },
				},
			},
			{
				id: "dotRightEye",
			...
			},
			{
				...
				params: {
					...
					radius: { v: 0.007 },
					color: { v: { r: 0.55, g: 0.28, b: 0.2, a: 1.0 } },
				},
			},
			{
				id: "dotSmileRight",
