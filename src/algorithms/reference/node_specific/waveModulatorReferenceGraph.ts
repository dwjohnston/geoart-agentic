...
const graph = new AlgorithmBuilder({ title: 'Wave Modulator' })
	.addControlNode({
		id: 'modFrequency',
		type: 'slider',
		params: { label: { v: 'Mod Frequency' }, min: { v: 0.1 }, max: { v: 10 }, step: { v: 0.1 }, value: { v: 2 } },
	})
	.addControlNode({
		id: 'modAmplitude',
		type: 'slider',
		params: { label: { v: 'Mod Amplitude' }, min: { v: 0 }, max: { v: 2 }, step: { v: 0.01 }, value: { v: 1 } },
	})
	...
	.addControlNode({
		id: 'primaryFrequency',
		type: 'slider',
		params: { label: { v: 'Primary Frequency' }, min: { v: 0.1 }, max: { v: 10 }, step: { v: 0.1 }, value: { v: 1 } },
	})
	.addControlNode({
		id: 'primaryAmplitude',
		type: 'slider',
	...
	.addControlNode({
		...
		type: 'slider',
		params: { label: { v: 'Primary Sampler Temporal Impact' }, min: { v: 0 }, max: { v: 1 }, step: { v: 0.01 }, value: { v: 1 } },
	})
	.addControlNode({
		id: 'numPoints',
		type: 'slider',
