...
import { linesThroughPointGraph } from './reference/node_specific/linesThroughPointReferenceGraph';
...
export const GRAPHS: GraphEntry[] = [
  ...
  { id: 'linesThroughPoint', name: 'Lines Through Point', graph: linesThroughPointGraph }
];
