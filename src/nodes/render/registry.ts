...
import { lineThroughAPointNodeDef } from './nodes/lineThroughAPoint.node';

export const renderRegistry = new Map<string, LegacyRenderNodeDef>(
  ([timedLineNodeDef, timedLineArrayNodeDef, circleNodeDef, connectDotsNodeDef, lineThroughAPointNodeDef] as Array<RenderNodeDef<RenderNodeKinds>>)
