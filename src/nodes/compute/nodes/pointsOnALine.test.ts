...
const A = { x: 0, y: 0, r: 0, g: 0, b: 0, a: 1 };
const B = { x: 1, y: 1, r: 1, g: 1, b: 1, a: 1 };
...
describe('pointsOnALineNodeDef', () => {
  ...
  test('numberOfPoints=3 returns endpoints and correct midpoint', () => {
    ...
    expect(points[0]).toEqual(A);
    expect(points[2]).toEqual(B);
    expect(points[1]).toEqual({ x: 0.5, y: 0.5, r: 0.5, g: 0.5, b: 0.5, a: 1 });
  });
  ...
  test('colour interpolation is correct at midpoint', () => {
    const red = { x: 0, y: 0, r: 1, g: 0, b: 0, a: 1 };
    const blue = { x: 0, y: 0, r: 0, g: 0, b: 1, a: 1 };
  ...
  test('modulator displaces points perpendicular to line', () => {
    const fromPoint = { x: 0, y: 0, r: 0, g: 0, b: 0, a: 1 };
    const toPoint = { x: 2, y: 0, r: 0, g: 0, b: 0, a: 1 };
