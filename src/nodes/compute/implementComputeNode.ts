...
export function convertComputeNodeDefinitionToLegacyDefinition<
	T extends ComputeNodeKinds,
>(value: ComputeNodeDef<T>): LegacyComputeNodeDef {
...
function valueTypeToPortType(
	valueType: string,
): LegacyComputeNodePortDef["type"] {
