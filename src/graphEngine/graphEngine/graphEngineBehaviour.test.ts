...
describe("graph engine - unnecessary node evaluation", () => {
	test("nodes only reevaluate if something has actually changed", () => {
		...
		const legacyPolygonDef = convertRenderNodeDefToLegacy(
			mockUnchangingPolygonDef,
		);
				...
				nodes: [
					{
						...
						params: {
							...
							centerPoints: {
								v: [
									{ v: { x: 1, y: 1, dx: 0, dy: 0, r: 1, g: 1, b: 1, a: 1 } },
								],
							},
						},
					},
					{
						...
						params: {
							points: {
								v: [
									{ v: { x: 0, y: 0, dx: 0, dy: 0, r: 1, g: 1, b: 1, a: 1 } },
									{ v: { x: 1, y: 0, dx: 0, dy: 0, r: 1, g: 1, b: 1, a: 1 } },
									{ v: { x: 0.5, y: 1, dx: 0, dy: 0, r: 1, g: 1, b: 1, a: 1 } },
								],
							},
						},
					},
