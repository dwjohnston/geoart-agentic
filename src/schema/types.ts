 ...
 * @deprecated - use the type helpers instead
 */
export type ColorPointValue = { kind: 'colorPoint'; v: { x: number; y: number; r: number; g: number; b: number; a: number, dx: number, dy: number } };
/**
 * @deprecated - use the type helpers instead
 */
export type ColorPointArrayValue = { kind: 'colorPointArray'; v: Array<{ x: number; y: number; r: number; g: number; b: number; a: number, dx: number, dy: number }> };
/**
 * @deprecated - use the type helpers instead
 */
