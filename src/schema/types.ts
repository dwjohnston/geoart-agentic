...
export type ColorPointValue = { kind: 'colorPoint'; v: { x: number; y: number; dx: number; dy: number; r: number; g: number; b: number; a: number } };
export type ColorPointArrayValue = { kind: 'colorPointArray'; v: Array<{ x: number; y: number; dx: number; dy: number; r: number; g: number; b: number; a: number }> };
